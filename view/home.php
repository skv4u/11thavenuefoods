    ...
    <div class="row">
      <div class="gallery_product col-md-4 filter rice">
        <div class="sm-padding">
          <div class="b-item">
            <div class="b-thumb"> <img src="img/mountaion.jpg" alt="post"></div>
      ...
      <div class="gallery_product col-md-4 filter fruits">
        <div class="sm-padding">
          <div class="b-item">
            <div class="b-thumb"> <img src="img/mountaion.jpg" alt="post"></div>
            <div class="blog-content">
      ...
      <div class="col-md-12">
        <div id="testimonial-slider" class="owl-carousel">
          <div class="testimonial">
            ...
            <small class="post">- Archietect</small> </div>
          <div class="testimonial">
            ...
            <small class="post">- Engineer </small> </div>
          <div class="testimonial">
            ...
            <small class="post">- Graphic Designer</small> </div>
        </div>
      </div>
    </div>
  </div>

    ...
    <div class="row pl-0">
      <div class="col-md-12">
        ...
        <ul>
          ...
          <h4 class=" mb-4">Phytochemicals</h4>
          <li>
            <p>
              Numerous phytochemicals are present in mango peel and pulp, such as the triterpene, lupeol which is under basic research for its potential biological effects.
            </p>
          </li>
          <li>
            <p>
